...
void Board_initADC(void)
{
    ...
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER3, ADC_TRIGGER_EPWM1_SOCA, DAB_IND_I_SENSE_CH , ACQPS_SYS_CLKS);
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER4, ADC_TRIGGER_EPWM1_SOCA, DAB_I_OUT_SENSE_CH, ACQPS_SYS_CLKS);
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER5, ADC_TRIGGER_EPWM1_SOCA, DAB_VOUT_SENSE_CH, ACQPS_SYS_CLKS);
